...
const CATEGORY_CONFIG: Record<string, { labelKey: string; color: string; Icon: React.ComponentType<{ size: number; color: string; strokeWidth: number }> }> = {
  ...
  cuidados:     { labelKey: 'expenses.category.cuidados',     color: colors.click,   Icon: Shield },
  treinamento:  { labelKey: 'expenses.category.treinamento',  color: colors.click,   Icon: Dumbbell },
