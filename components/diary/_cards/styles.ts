...
export const styles = StyleSheet.create({
  ...
  monthTitle: { fontFamily: 'Sora_700Bold', fontSize: fs(16), color: colors.click },
  ...
  monthStatValue: { fontFamily: 'JetBrainsMono_700Bold', fontSize: fs(14), color: colors.click },
  ...
  specialHeader: { flexDirection: 'row', alignItems: 'center', gap: rs(6), backgroundColor: colors.warning + '15', paddingHorizontal: rs(10), paddingVertical: rs(6), borderRadius: rs(8), marginBottom: rs(10), alignSelf: 'flex-start' },
  specialText: { fontFamily: 'Sora_700Bold', fontSize: fs(10), color: colors.warning, letterSpacing: 0.5 },
  registrationBadge: { flexDirection: 'row', alignItems: 'center', gap: rs(6), backgroundColor: colors.warning + '20', borderWidth: 1, borderColor: colors.warning + '40', paddingHorizontal: rs(10), paddingVertical: rs(6), borderRadius: rs(8), marginBottom: rs(10), alignSelf: 'flex-start' },
  registrationText: { fontFamily: 'Sora_700Bold', fontSize: fs(10), color: colors.warning, letterSpacing: 0.5 },
  ...
  narrationSection: { backgroundColor: colors.click + '08', borderWidth: 1, borderColor: colors.click + '12', borderRadius: rs(12), padding: rs(12) },
  narrationHeader: { flexDirection: 'row', alignItems: 'center', gap: rs(6), marginBottom: rs(8) },
  narrationTitle: { fontFamily: 'Sora_600SemiBold', fontSize: fs(11), color: colors.click, flex: 1 },
  ...
  milestoneTitle: { fontFamily: 'Sora_700Bold', fontSize: fs(16), color: colors.warning, textAlign: 'center', marginTop: rs(10) },
  ...
  badgeChip: { flexDirection: 'row', alignItems: 'center', gap: rs(6), backgroundColor: colors.warning + '15', paddingHorizontal: rs(12), paddingVertical: rs(6), borderRadius: rs(8), marginTop: rs(10) },
  badgeChipText: { fontFamily: 'Sora_700Bold', fontSize: fs(11), color: colors.warning },
  ...
  processingCard: { borderLeftWidth: rs(3), borderLeftColor: colors.click },
  processingRow: { flexDirection: 'row', alignItems: 'center', gap: rs(8), marginBottom: rs(6) },
  processingText: { fontFamily: 'Sora_600SemiBold', fontSize: fs(12), color: colors.click },
  ...
  retryBtn: { flexDirection: 'row', alignItems: 'center', gap: rs(6), alignSelf: 'flex-start', paddingVertical: rs(6), paddingHorizontal: rs(12), backgroundColor: colors.clickSoft, borderRadius: rs(8) },
  retryText: { fontFamily: 'Sora_600SemiBold', fontSize: fs(12), color: colors.click },
  ...
  ocrDocTypeBadge: { backgroundColor: colors.click + '20', paddingHorizontal: rs(8), paddingVertical: rs(2), borderRadius: rs(6) },
  ocrDocTypeText: { fontFamily: 'Sora_700Bold', fontSize: fs(9), color: colors.click, letterSpacing: 0.5 },
  ocrTotalBox: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: rs(8), backgroundColor: colors.click + '12', borderWidth: 1, borderColor: colors.click + '25', borderRadius: rs(10), paddingHorizontal: rs(12), paddingVertical: rs(8), marginHorizontal: rs(10), marginVertical: rs(6) },
  ocrTotalLabel: { flex: 1, fontFamily: 'Sora_700Bold', fontSize: fs(11), color: colors.click, letterSpacing: 0.5 },
  ocrTotalValue: { flexShrink: 0, fontFamily: 'JetBrainsMono_700Bold', fontSize: fs(16), color: colors.click },
  ...
  ocrEditBar: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: rs(6), marginHorizontal: rs(10), marginTop: rs(8), marginBottom: rs(4), paddingVertical: rs(9), borderRadius: rs(10), borderWidth: 1, borderColor: colors.click + '50', backgroundColor: colors.click + '10' },
  ocrEditBarText: { fontFamily: 'Sora_700Bold', fontSize: fs(12), color: colors.click },
  ...
  ocrSaveBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: rs(5), paddingHorizontal: rs(14), paddingVertical: rs(9), borderRadius: rs(10), backgroundColor: colors.click },
  ocrSaveBtnText: { fontFamily: 'Sora_700Bold', fontSize: fs(12), color: '#fff' },
  ocrEditInput: { flex: 1, borderBottomWidth: 1, borderBottomColor: colors.click + '60', paddingVertical: rs(2), paddingHorizontal: rs(4), color: colors.text, backgroundColor: colors.bgCard },
  ...
  schedIconWrap: { width: rs(26), height: rs(26), borderRadius: rs(8), backgroundColor: colors.textSec, alignItems: 'center', justifyContent: 'center' },
  ...
  schedAIBadge: { backgroundColor: colors.click + '20', paddingHorizontal: rs(6), paddingVertical: rs(2), borderRadius: rs(6) },
  schedAIText: { fontFamily: 'Sora_700Bold', fontSize: fs(9), color: colors.click, letterSpacing: 0.5 },
